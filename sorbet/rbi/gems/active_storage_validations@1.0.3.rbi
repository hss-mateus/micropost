...
class ActiveStorageValidations::Metadata
  ...
  # source://active_storage_validations//lib/active_storage_validations/metadata.rb#134
  def logger; end
  ...
  # @return [Boolean]
  #
  # source://active_storage_validations//lib/active_storage_validations/metadata.rb#104
