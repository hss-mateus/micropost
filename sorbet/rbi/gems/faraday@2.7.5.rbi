...
class Faraday::Request < ::Struct
  ...
  #
  # source://faraday//lib/faraday/request.rb#90
  def [](key); end

  # @param key [Object] key of header to write
  # @param value [Object] value of header
  #
  # source://faraday//lib/faraday/request.rb#96
  def []=(key, value); end
  ...
  #
  # source://faraday//lib/faraday/request.rb#59
  def headers=(hash); end
  ...
  #
  # source://faraday//lib/faraday/request.rb#103
  ...
  #
  # source://faraday//lib/faraday/request.rb#117
  ...
  #
  # source://faraday//lib/faraday/request.rb#127
  ...
  # @return [void]
  #
  # source://faraday//lib/faraday/request.rb#72
