...
class PgQuery::CreateForeignServerStmt
  ...
  def initialize(fdwname: nil, if_not_exists: nil, options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), servername: nil, servertype: nil, version: nil); end
