...
class PgQuery::XmlExpr
  ...
  def initialize(arg_names: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), location: nil, name: nil, named_args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), op: nil, type: nil, typmod: nil, xmloption: nil, xpr: nil); end
