...
class PgQuery::AlterEnumStmt
  ...
  def initialize(new_val: nil, new_val_is_after: nil, new_val_neighbor: nil, old_val: nil, skip_if_new_val_exists: nil, type_name: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node)); end
