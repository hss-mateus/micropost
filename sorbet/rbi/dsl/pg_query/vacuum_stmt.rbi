...
class PgQuery::VacuumStmt
  ...
  def initialize(is_vacuumcmd: nil, options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), rels: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node)); end
