...
class PgQuery::RuleStmt
  ...
  def initialize(actions: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), event: nil, instead: nil, relation: nil, replace: nil, rulename: nil, where_clause: nil); end
