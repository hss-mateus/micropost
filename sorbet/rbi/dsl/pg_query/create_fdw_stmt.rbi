...
class PgQuery::CreateFdwStmt
  ...
  def initialize(fdwname: nil, func_options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node)); end
