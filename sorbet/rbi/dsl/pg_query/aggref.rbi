...
class PgQuery::Aggref
  sig do
    params(
      ...
      aggtranstype: T.nilable(Integer),
  ...
  def initialize(aggargtypes: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), aggcollid: nil, aggdirectargs: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), aggdistinct: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), aggfilter: nil, aggfnoid: nil, aggkind: nil, agglevelsup: nil, aggno: nil, aggorder: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), aggsplit: nil, aggstar: nil, aggtransno: nil, aggtranstype: nil, aggtype: nil, aggvariadic: nil, args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), inputcollid: nil, location: nil, xpr: nil); end
  ...
  sig { returns(Integer) }
  def aggtranstype; end

  sig { params(value: Integer).void }
  def aggtranstype=(value); end
