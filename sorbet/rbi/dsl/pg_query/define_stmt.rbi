...
class PgQuery::DefineStmt
  ...
  def initialize(args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), definition: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), defnames: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), if_not_exists: nil, kind: nil, oldstyle: nil, replace: nil); end
