...
class PgQuery::FuncExpr
  ...
  def initialize(args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), funccollid: nil, funcformat: nil, funcid: nil, funcresulttype: nil, funcretset: nil, funcvariadic: nil, inputcollid: nil, location: nil, xpr: nil); end
