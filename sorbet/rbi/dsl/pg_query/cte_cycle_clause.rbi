...
class PgQuery::CTECycleClause
  ...
  def initialize(cycle_col_list: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), cycle_mark_collation: nil, cycle_mark_column: nil, cycle_mark_default: nil, cycle_mark_neop: nil, cycle_mark_type: nil, cycle_mark_typmod: nil, cycle_mark_value: nil, cycle_path_column: nil, location: nil); end
