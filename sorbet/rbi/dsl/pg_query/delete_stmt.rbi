...
class PgQuery::DeleteStmt
  ...
  def initialize(relation: nil, returning_list: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), using_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), where_clause: nil, with_clause: nil); end
