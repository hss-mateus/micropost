...
class PgQuery::RangeFunction
  ...
  def initialize(alias: nil, coldeflist: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), functions: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), is_rowsfrom: nil, lateral: nil, ordinality: nil); end
