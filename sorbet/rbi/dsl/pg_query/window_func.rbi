...
class PgQuery::WindowFunc
  ...
  def initialize(aggfilter: nil, args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), inputcollid: nil, location: nil, winagg: nil, wincollid: nil, winfnoid: nil, winref: nil, winstar: nil, wintype: nil, xpr: nil); end
