...
class PgQuery::OnConflictExpr
  ...
  def initialize(action: nil, arbiter_elems: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), arbiter_where: nil, constraint: nil, excl_rel_index: nil, excl_rel_tlist: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), on_conflict_set: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), on_conflict_where: nil); end
