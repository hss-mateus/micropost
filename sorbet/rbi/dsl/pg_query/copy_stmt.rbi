...
class PgQuery::CopyStmt
  ...
  def initialize(attlist: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), filename: nil, is_from: nil, is_program: nil, options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), query: nil, relation: nil, where_clause: nil); end
