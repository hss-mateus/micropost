...
class PgQuery::FieldStore
  ...
  def initialize(arg: nil, fieldnums: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), newvals: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), resulttype: nil, xpr: nil); end
