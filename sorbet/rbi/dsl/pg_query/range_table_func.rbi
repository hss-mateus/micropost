...
class PgQuery::RangeTableFunc
  ...
  def initialize(alias: nil, columns: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), docexpr: nil, lateral: nil, location: nil, namespaces: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), rowexpr: nil); end
