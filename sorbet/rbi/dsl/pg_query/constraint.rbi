...
class PgQuery::Constraint
  ...
  def initialize(access_method: nil, conname: nil, contype: nil, cooked_expr: nil, deferrable: nil, exclusions: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), fk_attrs: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), fk_del_action: nil, fk_del_set_cols: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), fk_matchtype: nil, fk_upd_action: nil, generated_when: nil, including: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), indexname: nil, indexspace: nil, initdeferred: nil, initially_valid: nil, is_no_inherit: nil, keys: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), location: nil, nulls_not_distinct: nil, old_conpfeqop: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), old_pktable_oid: nil, options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), pk_attrs: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), pktable: nil, raw_expr: nil, reset_default_tblspc: nil, skip_validation: nil, where_clause: nil); end
