...
class PgQuery::TypeName
  ...
  def initialize(array_bounds: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), location: nil, names: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), pct_type: nil, setof: nil, type_oid: nil, typemod: nil, typmods: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node)); end
