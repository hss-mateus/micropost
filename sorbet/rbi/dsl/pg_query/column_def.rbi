...
class PgQuery::ColumnDef
  ...
  def initialize(coll_clause: nil, coll_oid: nil, colname: nil, compression: nil, constraints: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), cooked_default: nil, fdwoptions: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), generated: nil, identity: nil, identity_sequence: nil, inhcount: nil, is_from_type: nil, is_local: nil, is_not_null: nil, location: nil, raw_default: nil, storage: nil, type_name: nil); end
