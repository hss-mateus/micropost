...
class PgQuery::GrantStmt
  ...
  def initialize(behavior: nil, grant_option: nil, grantees: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), grantor: nil, is_grant: nil, objects: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), objtype: nil, privileges: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), targtype: nil); end
