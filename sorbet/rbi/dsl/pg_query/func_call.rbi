...
class PgQuery::FuncCall
  ...
  def initialize(agg_distinct: nil, agg_filter: nil, agg_order: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), agg_star: nil, agg_within_group: nil, args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), func_variadic: nil, funcformat: nil, funcname: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), location: nil, over: nil); end
