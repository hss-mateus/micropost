...
class PgQuery::SubscriptingRef
  ...
  def initialize(refassgnexpr: nil, refcollid: nil, refcontainertype: nil, refelemtype: nil, refexpr: nil, reflowerindexpr: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), refrestype: nil, reftypmod: nil, refupperindexpr: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), xpr: nil); end
