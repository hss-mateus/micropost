...
class PgQuery::CreateStatsStmt
  ...
  def initialize(defnames: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), exprs: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), if_not_exists: nil, relations: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), stat_types: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), stxcomment: nil, transformed: nil); end
