...
class PgQuery::ViewStmt
  ...
  def initialize(aliases: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), query: nil, replace: nil, view: nil, with_check_option: nil); end
