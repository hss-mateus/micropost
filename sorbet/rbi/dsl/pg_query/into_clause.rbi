...
class PgQuery::IntoClause
  ...
  def initialize(access_method: nil, col_names: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), on_commit: nil, options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), rel: nil, skip_data: nil, table_space_name: nil, view_query: nil); end
