...
class PgQuery::SelectStmt
  ...
  def initialize(all: nil, distinct_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), from_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), group_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), group_distinct: nil, having_clause: nil, into_clause: nil, larg: nil, limit_count: nil, limit_offset: nil, limit_option: nil, locking_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), op: nil, rarg: nil, sort_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), target_list: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), values_lists: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), where_clause: nil, window_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), with_clause: nil); end
