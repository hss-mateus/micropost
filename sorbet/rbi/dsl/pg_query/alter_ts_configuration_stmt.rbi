...
class PgQuery::AlterTSConfigurationStmt
  ...
  def initialize(cfgname: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), dicts: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), kind: nil, missing_ok: nil, override: nil, replace: nil, tokentype: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node)); end
