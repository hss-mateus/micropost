...
class PgQuery::CreateOpClassStmt
  ...
  def initialize(amname: nil, datatype: nil, is_default: nil, items: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), opclassname: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), opfamilyname: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node)); end
