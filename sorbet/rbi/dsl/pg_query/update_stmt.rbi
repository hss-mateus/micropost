...
class PgQuery::UpdateStmt
  ...
  def initialize(from_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), relation: nil, returning_list: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), target_list: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), where_clause: nil, with_clause: nil); end
