...
class PgQuery::CreateTrigStmt
  ...
  def initialize(args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), columns: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), constrrel: nil, deferrable: nil, events: nil, funcname: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), initdeferred: nil, isconstraint: nil, relation: nil, replace: nil, row: nil, timing: nil, transition_rels: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), trigname: nil, when_clause: nil); end
