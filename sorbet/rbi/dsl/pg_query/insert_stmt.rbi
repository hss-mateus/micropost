...
class PgQuery::InsertStmt
  ...
  def initialize(cols: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), on_conflict_clause: nil, override: nil, relation: nil, returning_list: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), select_stmt: nil, with_clause: nil); end
