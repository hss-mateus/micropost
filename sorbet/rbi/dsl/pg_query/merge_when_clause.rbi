...
class PgQuery::MergeWhenClause
  ...
  def initialize(command_type: nil, condition: nil, matched: nil, override: nil, target_list: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), values: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node)); end
