...
class PgQuery::CreateDomainStmt
  ...
  def initialize(coll_clause: nil, constraints: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), domainname: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), type_name: nil); end
