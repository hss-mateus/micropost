...
class PgQuery::Var
  sig do
    params(
      ...
      varattnosyn: T.nilable(Integer),
      varcollid: T.nilable(Integer),
      varlevelsup: T.nilable(Integer),
      varno: T.nilable(Integer),
      varnosyn: T.nilable(Integer),
      vartype: T.nilable(Integer),
      vartypmod: T.nilable(Integer),
      xpr: T.nilable(PgQuery::Node)
    ).void
  end
  def initialize(location: nil, varattno: nil, varattnosyn: nil, varcollid: nil, varlevelsup: nil, varno: nil, varnosyn: nil, vartype: nil, vartypmod: nil, xpr: nil); end
