...
class PgQuery::CreatePolicyStmt
  ...
  def initialize(cmd_name: nil, permissive: nil, policy_name: nil, qual: nil, roles: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), table: nil, with_check: nil); end
