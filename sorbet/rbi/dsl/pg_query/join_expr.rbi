...
class PgQuery::JoinExpr
  ...
  def initialize(alias: nil, is_natural: nil, join_using_alias: nil, jointype: nil, larg: nil, quals: nil, rarg: nil, rtindex: nil, using_clause: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node)); end
