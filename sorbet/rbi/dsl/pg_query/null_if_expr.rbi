...
class PgQuery::NullIfExpr
  ...
  def initialize(args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), inputcollid: nil, location: nil, opcollid: nil, opfuncid: nil, opno: nil, opresulttype: nil, opretset: nil, xpr: nil); end
