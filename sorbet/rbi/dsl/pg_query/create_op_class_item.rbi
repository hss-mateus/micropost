...
class PgQuery::CreateOpClassItem
  ...
  def initialize(class_args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), itemtype: nil, name: nil, number: nil, order_family: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), storedtype: nil); end
