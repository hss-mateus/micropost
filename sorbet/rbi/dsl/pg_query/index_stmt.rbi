...
class PgQuery::IndexStmt
  sig do
    params(
      ...
      old_first_relfilenode_subid: T.nilable(Integer),
      old_node: T.nilable(Integer),
  ...
  def initialize(access_method: nil, concurrent: nil, deferrable: nil, exclude_op_names: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), idxcomment: nil, idxname: nil, if_not_exists: nil, index_including_params: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), index_oid: nil, index_params: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), initdeferred: nil, isconstraint: nil, nulls_not_distinct: nil, old_create_subid: nil, old_first_relfilenode_subid: nil, old_node: nil, options: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), primary: nil, relation: nil, reset_default_tblspc: nil, table_space: nil, transformed: nil, unique: nil, where_clause: nil); end
  ...
  sig { void }
  def clear_old_first_relfilenode_subid; end

  sig { void }
  def clear_old_node; end
  ...
  sig { returns(Integer) }
  def old_first_relfilenode_subid; end

  sig { params(value: Integer).void }
  def old_first_relfilenode_subid=(value); end

  sig { returns(Integer) }
  def old_node; end

  sig { params(value: Integer).void }
  def old_node=(value); end
