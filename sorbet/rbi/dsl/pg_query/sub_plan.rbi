...
class PgQuery::SubPlan
  ...
  def initialize(args: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), first_col_collation: nil, first_col_type: nil, first_col_typmod: nil, par_param: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), parallel_safe: nil, param_ids: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), per_call_cost: nil, plan_id: nil, plan_name: nil, set_param: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), startup_cost: nil, sub_link_type: nil, testexpr: nil, unknown_eq_false: nil, use_hash_table: nil, xpr: nil); end
