...
class PgQuery::CreatePLangStmt
  ...
  def initialize(plhandler: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), plinline: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), plname: nil, pltrusted: nil, plvalidator: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), replace: nil); end
