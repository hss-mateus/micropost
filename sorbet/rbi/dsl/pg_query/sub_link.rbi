...
class PgQuery::SubLink
  ...
  def initialize(location: nil, oper_name: Google::Protobuf::RepeatedField.new(:message, PgQuery::Node), sub_link_id: nil, sub_link_type: nil, subselect: nil, testexpr: nil, xpr: nil); end
