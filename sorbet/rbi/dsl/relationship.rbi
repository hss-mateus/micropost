...
class Relationship
  ...
  module GeneratedAssociationMethods
    ...
    def build_followed(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::User) }
    def build_follower(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::User) }
    def create_followed(*args, &blk); end
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.nilable(::Integer)) }
    def followed_id_before_last_save; end

    sig { returns(T.untyped) }
    def followed_id_before_type_cast; end
    ...
    sig { returns(T::Boolean) }
    def followed_id_previously_changed?; end

    sig { returns(T.nilable(::Integer)) }
    def followed_id_previously_was; end

    sig { returns(T.nilable(::Integer)) }
    def followed_id_was; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_followed_id?; end
